...
class RequirementsControllerTest < ActionController::TestCase
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post :create, requirement: { description: @requirement.description, event_id: @requirement.event_id, name: @requirement.name, rule_id: @requirement.rule_id }
    end
  ...
  test "should update requirement" do
    patch :update, id: @requirement, requirement: { description: @requirement.description, event_id: @requirement.event_id, name: @requirement.name, rule_id: @requirement.rule_id }
    assert_redirected_to requirement_path(assigns(:requirement))
  end
